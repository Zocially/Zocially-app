...
def main_app():
    ...
    with st.sidebar:
        ...
        st.divider()
        st.info("This tool uses Google Gemini to analyze your CV and generate tailored content.")
                    ...
                    if job_details:
                        ...
                        with tab2:
                            ...
                            try:
                                ...
                                docx_file = create_docx_from_markdown(new_cv)
                                st.download_button(
                                    label="Download Tailored CV (Word)",
                                    data=docx_file,
                                    file_name=f"Tailored_CV_{safe_title}.docx",
